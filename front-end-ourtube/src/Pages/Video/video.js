            ...
            <div className="videoPostSection">
                    ...
                    <div className="youtube_video_ProfileBlock">
                        <div className="youtube_video_ProfileBlock_left">
                            <Link to={`/user/${data?.user?._id}`} className="youtube_video_ProfileBlock_left_img">
                                <img className='youtube_video_ProfileBlock_left_image' src={data?.user?.profilePic} alt='hello' />
                            </Link>
                ...
                <div className="youtubeCommentSection">
                    ...
                    <div className="youtubeSelfComment">
                        {/* done------------------------- */}
                        <img className='video_youtubeSelfCommentProfile' src={data?.user?.profilePic} alt='hello' />
                            ...
                            comments.map((item, index) => {
                                return (
                                    <div className="youtubeSelfComment" key={index}>
                                        <img className='video_youtubeSelfCommentProfile' src={item?.user?.profilePic} alt='hello' />
            ...
            <div className="videoSuggestions">
                ...
                <div className="videoSuggestionsBlock">
                    <div className="video_suggetion_thumbnail">
                        <img src="https://th.bing.com/th/id/OIP.8gLtXrl4KYPfPA6QyMnlUwHaEK?w=304&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" className='video_suggetion_thumbnail_img' alt='hello' />
                    </div>
