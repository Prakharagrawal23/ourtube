  ...
  return (
    <div className={sideNavbar?"home-sideNavbar":"homeSideNavbarHide"}>
            ...
            <div className="home_sideNavbarMiddle">
                ...
                {/*done-------------------------- Please watch the video for the code} */}
            ...
            <div className="home_sideNavbarMiddle">
                ...
                <div className="home_sideNavbarTopOption">
                    <img className='home_sideNavbar_ImgLogo' src='https://th.bing.com/th/id/R.bce6ed4af85677ce3b6908ac7e8e631b?rik=DFwXRhY0pZxYIg&pid=ImgRaw&r=0' alt='The LallanTop Logo'  />
